...
if (!$valido) {
    die("<div class='alert alert-error'>Link inválido ou expirado. <a href='esqueceuSenha.php'>Solicite um novo link</a></div>");
}
...
<head>
    ...
    <link rel="stylesheet" href="/tcc_final/css/style.css">
</head>
<body>
                ...
                <?php else: ?>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-foooter">
                            <p><a href="inicio.html">Voltar à página inicial</a></p>
                        </div>
                    </form>
                <?php endif; ?>
            </div>
